...
CREATE TABLE `categorylist` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '카테고리 고유 번호',
  `name` varchar(45) DEFAULT NULL COMMENT '카테고리 이름',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_UNIQUE` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='옷 구분 카테고리';
...
INSERT INTO `categorylist` VALUES (5,'가방'),(2,'상의'),(4,'신발'),(1,'아우터'),(6,'악세서리'),(3,'하의');
